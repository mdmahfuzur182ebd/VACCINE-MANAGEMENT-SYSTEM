      ...
      <div class="modal-content rounded-6 shadow">
        <div class="  p-5 " >
          ...
          <ul class="d-grid gap-4 my-5 list-unstyled">
            ...
            <a   href="addcity.php">      <h5 class="text-center">Add City for Hospital</h5></a> 
           </li>
           <li class=" btn btn-primary" style="height:70px;padding-top: 20px;" >
       ...
       <a   href="addvaccine.php">      <h5 class="text-center">Add Vaccine</h5></a> 
           ...
           <li class=" btn btn-primary" style="height:70px;padding-top: 20px;" >
       <a   href="addvaccinetohospital.php">      <h5 class="text-center">Provide Vaccine To Hospital</h5></a> 
           </li>
           <!-- <li class=" btn btn-primary" style="height:70px;padding-top: 20px;" >
