...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  $insertData = "INSERT INTO `vaccine`(  `Vaccine_Name`, `Company_Name`, `Import_Date`, `Production_Date`, `Expiry_Date`, `Production_Country`, `Amount_of_Vaccine_Stored`) VALUES ('".$vaccinename."', '".$companyname."','".$importdate."', '".$productiondate."', '".$expirydate."', '".$productioncompany."','".$vaccinestore."')";
